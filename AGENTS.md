...
**Key concepts:** brick-breaker, easter-egg, canvas, about-page, build-brickbreaker, esbuild-iife, tdd, e2e-testing, feature, markdown
...
**Key concepts:** brick-breaker, easter-egg, canvas, about-page, build-brickbreaker, esbuild-iife, tdd, e2e-testing
